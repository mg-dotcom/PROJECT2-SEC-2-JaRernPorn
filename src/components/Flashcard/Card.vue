...
<template>
  <div class="flex flex-row">
    <div class="cards relative">
      <optionFlashcard v-show="props.popup.optionFlashcard && SelectedIndex === props.index" :index="index"
        :popup="popup" @deleteCollection="deleteFlashcard(props.index)" @showRenameFlashcard="showRenameFlashcard">
      </optionFlashcard>

      <ranameFlashcard v-show="props.popup.renameFlashcard && SelectedIndex === props.index" :index="index"
        :popup="popup" :computedFlashcards="computedFlashcards" :SelectedIndex="SelectedIndex"
        @renameFlashcard="renameFlashcard"></ranameFlashcard>
      ...
      <img
        ...
        src="/img/flashcard-pic/option.svg" alt="option" @click="showOption(props.index)" />
      <div
        ...
        <div class="relative preserve-3d group-hover:my-rotate-y-30 w-full h-full duration-1000 cursor-pointer"
          :class="{ 'my-rotate-y-150': isClicked }" @click="showMeaning">
          <div
        ...
        'h-[140px]':
          ...
          10,
              ...
              <div class="flex items-center justify-center xl:text-2xl lg:text-2xl md:text-xl break-all" :class="{
        'h-auto':
        ...
        'h-[42px]':
          ...
          <div
            ...
            <div class="flex flex-col h-full items-center justify-center">
              <div class="font-medium break-all text-center xl:text-xl lg:text-xl md:text-2xl">
