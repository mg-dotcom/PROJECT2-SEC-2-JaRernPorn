...
<template>
    <div class="bg-main-bgColor h-screen w-full p-5">
        ...
        <section v-else-if="showAddCard">
            <div class="flex justify-center text-title text-5xl font-outfit font-semibold m-5">
                <h1>Collection Name</h1>
            </div>
            ...
            <div class="flex flex-col gap-10 items-center m-10">
                <div class="flex flex-col gap-5 font-Outfit font-medium text-lg">
                    <div>Chinese word
                        <div class="border border-gray-400 "><input type="text" v-model="newWord"></div>
                    </div>
                    <div>Meaning
                        <div class="border border-gray-400 "><input type="text" v-model="newMeaning"></div>
                    </div>
                </div>

                <div class="flex flex-wrap gap-6 justify-center">
                    <div @click="addFlashcard"
