<script setup>
import { ref } from 'vue'
import CollectionDisplay2 from './CollectionDisplay2.vue'
...
const saveEditedCollectionName = (editedCollectionName, collectionIndex) => {
  collections.value[collectionIndex] = editedCollectionName
}
</script>
  ...
  <div>
    ...
    <div v-for="(collection, index) in collections" :key="index">
      <CollectionDisplay2
        ...
        :saveEditedCollectionName="saveEditedCollectionName"
      ></CollectionDisplay2>
    </div>
  </div>
</template>
