...
<template>
  ...
  <section class="popup-renameCollection z-50 fixed top-0 left-0">
    <div class="bg-black bg-opacity-50 flex items-center justify-center min-h-screen w-screen relative z-0">
      <div
        ...
        <div class="flex flex-col items-center justify-center">
          ...
          <div class="my-7 flex flex-col items-center justify-center">
            <img class="w-[178px]" src="/img/flashcard-pic/collection.svg" alt="collection-pic" />
            <div class="w-[178px] overflow-hidden absolute flex items-center justify-center">
              <div
                class="text-2xl font-semibold font-outfit whitespace-normal break-all overflow-ellipsis max-h-[127px]">
                {{ renameCollectionName !== ""  ? renameCollectionName : props.computedCollections[props.index].name }}
              </div>
            </div>
          </div>
          <div class="flex gap-3">
            <div class="flex flex-col items-end gap-1">
              <input type="text" v-model.trim="renameCollectionName"
          ...
          'border-[#4096ff]': !emptyCollectionName,
                ...
                @keydown.enter="toUpdateName" @input="emptyCollectionName = isEmpty(renameCollectionName)" />
