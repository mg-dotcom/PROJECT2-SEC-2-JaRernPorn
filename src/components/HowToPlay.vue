...
<template>
  <div class="flex w-full h-screen top-0 right-0 left-0">
      ...
      >
        ...
        <div class="flex flex-col gap-4 py-3 justify-center items-center">
          <div class="text-black font-outfit">
            ...
            <div class="py-2">
              <img src="/homePage-pic/howtoplay-1.svg" alt="howtoplay-1" />
            </div>
          </div>
          <div class="text-black font-outfit">
            2. Select the unit.
            <div class="py-2">
              <img src="/homePage-pic/howtoplay-2.svg" alt="howtoplay-2" />
            </div>
          </div>
          <div class="text-black font-outfit">
          ...
          <div class="text-black font-outfit">
            4. Review the vocabulary you learned while playing.
            <div class="py-2">
              <img
                src="/homePage-pic/howtoplay-4.svg"
                alt="howtoplay-2"
                class="w-96"
              />
            </div>
